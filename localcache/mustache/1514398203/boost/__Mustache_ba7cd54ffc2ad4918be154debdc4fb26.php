...
class __Mustache_ba7cd54ffc2ad4918be154debdc4fb26 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        if ($partial = $this->mustache->loadPartial('theme_boost/header-secure')) {
...
';
        // 'hasblocks' section
        $value = $context->find('hasblocks');
        $buffer .= $this->section0f9cb46cb835aae6d2c8bd422d44bfae($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
    ...
    private function section0f9cb46cb835aae6d2c8bd422d44bfae(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
